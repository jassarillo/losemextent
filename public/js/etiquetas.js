                             ...
                             for(i =0; i < data.last_page; i++ )
                             {
                                ...
                                $('#pages-table').append(
                                    '<tr class="otrasFilas">' +
                                        ...
                                        '<td> <a href="imprEtiqAreas/'+rangeIni+'/'+rangeFin+'/'+'/'+'/0" target="_blank" class="btn btn-success btn-group-lg active" ><i class="fas fa-print"></i></a> </td> ' +
                                    '</tr>');
                                noInt++;
                            }
                            if(clasifica == "A")
                            {
                                $("#acantidad").val(data.total);
                            }
                            else if(clasifica == "B")
                            {
                                $("#rcantidad").val(data.total);
                            }
