                            ...
                            <div class="kt-form__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            {{ Form::label('', 'Lugar', array('class' => 'col-xl-3 col-lg-3 col-form-label')) }}
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                {{ Form::number('fecha_evento', auth()->user()->fecha_evento, array('class' => 'form-control')) }}
                                            </div>
                                        </div>
                                    
                                        <div class="form-group row">
                                            {{ Form::label('clasificacion', 'Clasificacion', array('class' => 'col-xl-3 col-lg-3 col-form-label')) }}
                                            <div class="col-lg-9 col-xl-6">
                                            <select class="form-control selectpicker" id="entregado" name="entregado">
                                                        <option value="1">Si</option>
                                                        <option value="2">No</option>
                                        ...
                                        <div class="form-group row">
                                            {{ Form::label('bien', 'Bien', array('class' => 'col-xl-3 col-lg-3 col-form-label')) }}
                                            <div class="col-lg-9 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            {{ Form::label('inventario', 'Inventario', array('class' => 'col-xl-3 col-lg-3 col-form-label')) }}
                                            <div class="col-lg-9 col-xl-6">
                                                {{ Form::text('lugar', auth()->user()->lugar, array('class' => 'form-control')) }}
                                            </div>
                                        </div> 
